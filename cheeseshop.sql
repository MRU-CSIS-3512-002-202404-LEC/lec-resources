...
--
-- Host: localhost    Database: cheeseshop

DROP DATABASE IF EXISTS `cheeseshop`;
...
VALUES (
    ...
    (
        3,
        'Munster is a strong-smelling soft cheese with a subtle taste, made mainly from milk first produced in the Vosges, between Alsace-Lorraine and Franche-Comte regions in France. The name \"Munster\" is derived from the Alsace town of Munster, where, among Vosgian abbeys and monasteries, the cheese was conserved and matured in monks\' cellars.',
        3
    ),
    (
        4,
...
VALUES ('', ''),
    (
        'jpratt',
        '$2y$10$05.mtXB6j6K6X/dgocxzqu3clLuIuGhx27mAswyYHLHjyvfHdp/Oq'
    );
